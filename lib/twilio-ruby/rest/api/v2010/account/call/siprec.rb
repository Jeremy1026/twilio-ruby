        ...
        class AccountContext < InstanceContext
          class CallContext < InstanceContext
            class SiprecList < ListResource
              ...
              #   {Call}[https://www.twilio.com/docs/voice/api/call-resource] the Siprec resource
              #   is associated with.
              ...
              # @param [String] name The user-specified name of this Siprec, if one was given
              #   when the Siprec was created. This may be used to stop the Siprec.
              # @param [String] connector_name Unique name used when configuring the connector
              #   via Marketplace Add-on.
              # @param [siprec.Track] track One of `inbound_track`, `outbound_track`,
              #   `both_tracks`.
              # @param [String] status_callback Absolute URL of the status callback.
              # @param [String] status_callback_method The http method for the status_callback
              #   (one of GET, POST).
            ...
            class SiprecContext < InstanceContext
              ...
              #   {Call}[https://www.twilio.com/docs/voice/api/call-resource] the Siprec resource
              #   is associated with.
              # @param [String] sid The SID of the Siprec resource, or the `name` used when
            ...
            class SiprecInstance < InstanceResource
              ...
              # @return [SiprecContext] SiprecContext for this SiprecInstance
              def context
              ...
              ##
              # @return [siprec.Status] The status - one of `stopped`, `in-progress`
              def status
                @properties['status']
              end
