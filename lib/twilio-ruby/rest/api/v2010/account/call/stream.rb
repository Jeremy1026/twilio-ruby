        ...
        class AccountContext < InstanceContext
          class CallContext < InstanceContext
            class StreamList < ListResource
              ...
              #   {Call}[https://www.twilio.com/docs/voice/api/call-resource] the Stream resource
              #   is associated with.
            ...
            class StreamContext < InstanceContext
              ...
              #   {Call}[https://www.twilio.com/docs/voice/api/call-resource] the Stream resource
              #   is associated with.
              # @param [String] sid The SID of the Stream resource, or the `name` used when
            ...
            class StreamInstance < InstanceResource
              ...
              # @return [StreamContext] StreamContext for this StreamInstance
              def context
                unless @instance_context
                  @instance_context = StreamContext.new(
                      @version,
                      @params['account_sid'],
                      @params['call_sid'],
                      @params['sid'],
              ...
              ##
              # @return [stream.Status] The status - one of `stopped`, `in-progress`
              def status
                @properties['status']
              end
