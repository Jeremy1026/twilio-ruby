  ...
  module REST
    class IpMessaging
      class V2 < Version
        ...
        # @return [Textgrid::REST::Ip_messaging::V2::CredentialContext] if sid was passed.
        ...
        ##
        # @param [String] sid The sid
        # @return [Textgrid::REST::Ip_messaging::V2::ServiceContext] if sid was passed.
