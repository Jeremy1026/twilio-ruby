...
describe 'ConferenceParticipant' do
  ...
  it "receives fetch responses" do
    ...
    actual = @client.insights.v1.conferences('CFXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX') \
                                .conference_participants('CPXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX').fetch()
  ...
  it "can read" do
    ...
    @holodeck.has_request?(Holodeck::Request.new(
        method: 'get',
        url: 'https://insights.twilio.com/v1/Conferences/CFXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Participants',
    ))).to eq(true)
  end
  ...
  it "receives read_with_label responses" do
    @holodeck.mock(Textgrid::Response.new(
        200,
      %q[
      {
