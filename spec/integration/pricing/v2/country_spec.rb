...
describe 'Country' do
  it "can read" do
    ...
    expect {
      @client.pricing.v2.countries.list()
  ...
  it "receives read_full responses" do
    ...
    actual = @client.pricing.v2.countries.list()
  ...
  it "can fetch" do
    ...
    expect {
      @client.pricing.v2.countries('US').fetch()
    }.to raise_exception(Textgrid::REST::TwilioError)
  ...
  it "receives fetch responses" do
    ...
    actual = @client.pricing.v2.countries('US').fetch()
